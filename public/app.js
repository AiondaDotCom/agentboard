...
function connectWebSocket(projectId) {
  ...
  socket.onmessage = (event) => {
    ...
    if (msg.type === 'connection_ack') {
      ...
      subscribeGlobal(socket, '11', 'runtimeStatusChanged', 'working idle codexWorking claudeWorking openCodeWorking cursorWorking workingSince workingForSeconds hosts { host workingCodex workingClaude workingOpenCode workingCursor idleCodex idleClaude idleOpenCode idleCursor reportedAt }');
